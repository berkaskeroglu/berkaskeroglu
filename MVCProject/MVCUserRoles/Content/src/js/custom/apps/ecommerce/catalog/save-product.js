...
var KTAppEcommerceSaveProduct = function () {
    ...
    const initSlider = () => {
        ...
        var hiddenInput = document.querySelector("#hiddenDiscountValue");
        ...
        slider.noUiSlider.on("update", function (values, handle) {
            var sliderValue = Math.round(values[handle]);
            if (handle) {
    ...
    const initDropzone = () => {
        var myDropzone = new Dropzone("#kt_ecommerce_add_product_media2", {
            /*url: "/Catalog/UploadImage",*/ // Set the url for your upload script location
            url: DZUrl,
            method: "POST",
