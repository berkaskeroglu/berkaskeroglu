        ...
        init: function () {
            ...
            ["#kt_ecommerce_add_product_description", "#kt_ecommerce_add_product_meta_description"].forEach((e => {
                ...
                init: function () {
                    ...
                    var productId = EditProductId; // Ürün ID'sini Model'den al
                    fetch(EditProductFetchUrl)
                        .then(response => response.json())
                        .then(data => {
                            data.forEach(function (photoUrl) {
                                var mockFile = { name: photoUrl.split('/').pop(), size: 12345 };
                                myDropzone.emit("addedfile", mockFile);
                                myDropzone.emit("thumbnail", mockFile, photoUrl);
